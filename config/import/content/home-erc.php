...
$genesis_grass_image_url = CHILD_URL . '/images/grass.jpg';
$logo_erc_head_url = CHILD_URL . '/images/kopje.png';
$logo_erc_shield_url = CHILD_URL . '/images/logo-erc-linkerborst.png';

return <<<CONTENT
<!-- wp:media-text {"align":"full","mediaId":1657,"mediaType":"image","isStackedOnMobile":true} -->
<div class="wp-block-media-text alignfull is-stacked-on-mobile"><figure class="wp-block-media-text__media"><img src="$genesis_grass_image_url" alt="" class="wp-image-1657"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":1} -->
...
<figure class="wp-block-image size-large"><img src="$genesis_grass_image_url" alt="" class="wp-image-1655"/></figure>
<!-- /wp:image --></div></div>
<!-- /wp:genesis-blocks/gb-column --></div></div>
<!-- /wp:genesis-blocks/gb-columns -->
CONTENT;
